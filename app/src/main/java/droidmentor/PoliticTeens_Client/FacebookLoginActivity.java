...
public class FacebookLoginActivity extends BaseActivity2 implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // [END initialize_auth]
        try {
            if (mDatabase.child("users").child(getUid()).child("username")!=null){
                ...
                /*mDatabase.child("users").addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        try
                        {
                            S.just_count = dataSnapshot.child("club_count").getValue(long.class);
                            Log.d("-========= -",Long.toString(S.just_count));
                        }
                        catch (NullPointerException e)
                        {
                            e.printStackTrace();
                            Log.d("에러부분 -11",Long.toString(S.just_count));
    ...
    private void writeNewUser(String userId, String name, String email,String photoUrl) {
        ...
        mDatabase.child("users").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                try
                {
                    S.just_count = dataSnapshot.child(getUid()).child("club").getValue(long.class);
                    Log.d("-========= -",Long.toString(S.just_count));
                }
                catch (NullPointerException e)
                {
                    mDatabase.child(getUid()).child("club").setValue(0);
                    Log.d("에러부분 -",Long.toString(S.just_count));
